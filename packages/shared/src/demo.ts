import type { BookRecord, EpubLocator, EpubRenditionDescriptor, PdfLocator, PdfRenditionDescriptor, TOCEntry, TxtRenditionDescriptor } from './types';
...
export const demoBook: BookRecord = {
  ...
  kind: 'epub',
  language: 'en',
  progress: { locator: epubLocator, lineProgress: 0.42, updatedAt: '2026-05-15T00:00:00.000Z' },
  bookmarks: [
    {
      id: 'bookmark-1',
...
export const demoTxt: TxtRenditionDescriptor = {
  kind: 'txt',
