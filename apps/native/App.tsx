  ...
  return (
    <SafeAreaView style={[styles.screen, { backgroundColor: t.background }]}>
      <View style={[{ backgroundColor: t.background }]}>
        ...
        <Text style={[{ color: t.cardForeground }]}>
          Epub stays reflowable, PDE stays page-native. Word and sentence highlighting while reading aloud.
        </Text>
      </View>

      <View style={[{ backgroundColor: t.background }]}>
        <Text style={[{ color: t.foreground }]}>Progress</Text>
        <Text style={[{ color: t.cardForeground }]}></Text>
      </View>
    </SafeAreaView>
  );
}
